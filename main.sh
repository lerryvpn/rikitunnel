...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/lerryvpn/izinsc/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/lerryvpn/izinsc/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/lerryvpn/izinsc/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/lerryvpn/rikitunnel/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/lerryvpn/izinsc/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/lerryvpn/izinsc/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/badbudstore"},{"text":"Contack","url":"https://wa.me/6283877826797"}]]}'
...
wget raw.githubusercontent.com/lerryvpn/rikitunnel/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
cd /bin
git clone  https://github.com/lerryvpn/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
